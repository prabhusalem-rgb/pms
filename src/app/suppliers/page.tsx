...
export default function SuppliersPage() {
  ...
  const [formData, setFormData] = useState({
    name: '',
    type: 'Material Supplier' as 'Material Supplier' | 'Subcontractor',
    contact_person: '',
    email: '',
    phone: '',
    cr_number: '',
  ...
  const downloadTemplate = () => {
    const headers = ['name', 'type', 'contact_person', 'email', 'phone', 'cr_number', 'vat_number'];
    const sampleRows = [
      ['Al Turki Enterprises LLC', 'Material Supplier', 'Salim Al-Harthy', 'salim@alturki.com', '+968 99112233', '1029384', 'OM1100029348'],
      ['Alcon Subcontracting', 'Subcontractor', 'Kumar Das', 'kumar@alcon.om', '+968 98765432', '2019283', 'OM2200038472']
    ];
    ...
    reader.onload = (event) => {
      try {
        ...
        for (let i = 1; i < lines.length; i++) {
          ...
          let type: 'Material Supplier' | 'Subcontractor' = 'Material Supplier';
          if (typeStr.toLowerCase().includes('sub') || typeStr.toLowerCase().includes('labour')) {
            type = 'Subcontractor';
          }
                  ...
                  <tr key={supplier.id}>
                    ...
                    <td>
                      <div style={{ fontSize: '0.85rem' }}>
                        ...
                        {!supplier.email && !supplier.phone && <span style={{ color: 'var(--text-muted)' }}>-</span>}
                      </div>
                    </td>
                    <td>
